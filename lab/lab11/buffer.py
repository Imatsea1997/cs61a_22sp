...
class Buffer:
    ...
    def __init__(self, source):
        ...
        # BEGIN
        "*** YOUR CODE HERE ***"
        self.token_generator = self.create_generator(source)
    ...
    def create_generator(self, source):
        ...
        "*** YOUR CODE HERE ***"
        for line in source:
            yield from line         # 正常情况：一次yield一个token
            yield EOL_TOKEN          # 一行结束
        # END
    ...
    def pop_first(self):
        ...
        self.current = next(self.token_generator, None)     # 如果stopIteration，则返回default
